...
param resourceGroupName string = 'rg-ist-dev'

param vNetResourceGroup string = 'rg-ist-networking-spokes-dev'
...
var aksBackendDomainName = 'ist-dev-00.${aksIngressDomainName}'
    ...
    frontendIPConfigurations: [
      {
        ...
        properties: {
          publicIPAddress: {
            id: '${subscription().id}/resourceGroups/${vNetResourceGroup}/providers/Microsoft.Network/publicIpAddresses/pip-ist-dev-00'
          }
        }
      }
    ]
